...
for line in lines[: min(num_samples, len(lines) - 1)]:
    ...
    try:
        ...
        target_text_wakati_list.append(target_wakati_words)
    except:
        print('faild wakati')
...
max_encoder_seq_length = max([len(wakati) for wakati in input_text_wakati_list])
max_decoder_seq_length = max([len(wakati) for wakati in target_text_wakati_list])
